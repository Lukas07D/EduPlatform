...
namespace SmartCertify.Infrastructure.Persistence;
...
public partial class SmartCertifyDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Server=tcp:smartcertify1.database.windows.net,1433;Initial Catalog=smartcertify;User ID=smartcertify;Password=Jestemczerwony666;Encrypt=True;TrustServerCertificate=False;");
